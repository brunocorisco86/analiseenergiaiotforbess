...
from src.data_cleaner import DataCleaner # Import DataCleaner
...
def main():
    ...
    data_excel_raw = data_loader_excel.get_data() # Get raw data from DataLoader

    if not data_excel_raw.empty:
        data_cleaner = DataCleaner(data_excel_raw) # Create DataCleaner instance
        data_cleaner.filter_excel_data() # Apply filtering
        data_cleaner.remove_unwanted_columns() # Apply column removal
